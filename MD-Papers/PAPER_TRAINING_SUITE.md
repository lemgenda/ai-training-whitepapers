...
- **Worker Lifecycle Graceful Shutdown**: Explicitly reaps training DataLoader iterator processes before spawning the validation pipeline. This eliminates System RAM hoarding by persistent training workers, stabilizing high-resolution validation on Kaggle kernels.
